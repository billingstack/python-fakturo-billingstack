# -*- coding: utf-8 -*-
#
# python-fakturo-billingstack documentation build configuration file, created by
...
htmlhelp_basename = 'python-fakturo-bilingstack-doc'
...
texinfo_documents = [
  ('index', 'python-fakturo-billngstack', u'Fakturo Billingstack Client Documentation',
   u'Bouvet ASA', 'python-fakturo-billingstack', 'One line description of project.',
   'Miscellaneous'),
]
